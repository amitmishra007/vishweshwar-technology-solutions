...
//   {
//     src: "/logo4.png",
//     name: "Description logo1",
//     description:
//       "Advanced SEO strategies to dominate search rankings and drive qualified traffic.",
//     link: "/services#seo",
//   },
//   {
//     src: "/logo5.png",
...
// const features = [
//   { title: "SEO & Search Optimization", id: "seo" },
//   { title: "Social Media Strategy", id: "social-media" },
//   { title: "PPC & Paid Campaigns", id: "ppc" },
//   { title: "Analytics & Tracking", id: "analytics" },
// ];

// /* ================= MAIN COMPONENT ================= */

// export default function MarketingSlide({ setHeroPaused }: SlideProps) {
...
//   /* RESPONSIVE ORBIT — WIDTH + HEIGHT SAFE */
//   useEffect(() => {
//     const updateLayout = () => {
...
//             >
//               Data-driven strategies to elevate brand presence, generate
//               qualified leads, and maximize measurable ROI.
//             </motion.p>
...
//               width: orbitSize,
//               height: orbitSize,
//               transform: `translateY(${orbitalOffset}px)`, // lifts orbital for SE/Duo
//             }}
//           >
//             {/* Core */}
//             <motion.div
...
//                     activePopupIndex={activePopupIndex} // new prop
//                     setActivePopupIndex={setActivePopupIndex} // new prop
//                   />
//                 );
//               })}
//             </motion.div>
...
//   // Hide popup when neither logo nor popup is hovered
//   useEffect(() => {
...
const services = [
  ...
  { title: "Analytics & Conversion Optimization", id: "analytics" },
];
      ...
      <div className="w-full max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-center px-6 md:px-8 gap-12">
        ...
        >
          <div className="flex flex-col gap-3 md:gap-4 items-center md:items-start justify-center">
            ...
            >
              Strategic SEO, performance marketing & growth systems designed to
              generate leads, scale traffic and maximize ROI.
            </motion.p>
            ...
            <motion.div
              ...
              className="flex justify-center md:justify-start mt-4"
            >
              <FancyButton text="Explore Marketing Services" href="/services" />
            </motion.div>
          </div>
        </motion.div>
