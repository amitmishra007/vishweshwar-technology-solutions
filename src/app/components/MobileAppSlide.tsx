...
export default function MobileAppSlide({ setHeroPaused }: SlideProps) {
  ...
  const services = [
    { title: "Android Application Development", id: "android-apps" },
    { title: "iOS App Development", id: "ios-apps" },
    {
      title: "Flutter / React Native / Kotlin Apps",
      id: "cross-platform-apps",
    },
    {
      title: "Enterprise Mobile App Systems",
    ...
    >
      <div className="w-full max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-center px-6 md:px-8 py-12 md:py-0">
        ...
        bg-clip-text text-transparent"
            ...
            >
              <FancyButton text="Explore Mobile Services" href="/services" />
            </motion.div>
          </div>
        </motion.div>
